        ...
        <Form inline>
          <Form-item>
            ...
            <Select clearable placeholder="状态" @on-change="searchManage"
              v-model="searchList.searchCondition.auditStatus" class="search_item">
          ...
          <Modal title="查看用户信息详情" width="55" :styles="{top: '70px'}" v-model="viewData.modalDetail">
            <div class="order_info">
              ...
              <h3 v-if="viewData.Detail.role===3">图片</h3>
              <Row v-if="viewData.Detail.role===3">
                <Col span="4">导师身份证:</Col>
                <Col span="18">
                <img :src="viewData.Detail.identityImage" class="img_item" preview="0" preview-text="导师身份证" />
                </Col>
              </Row>
              <Row v-if="viewData.Detail.role===3">
                <Col span="4">导师头像:</Col>
                <Col span="18">
                <img :src="viewData.Detail.imageSrc" class="img_item" preview="0" preview-text="导师头像" />
                </Col>
              </Row>
