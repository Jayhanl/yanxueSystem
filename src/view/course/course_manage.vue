        ...
        <Form inline>
          ...
          <Modal v-model="viewData.modalAdd" title="添加课程" :mask-closable="false" @on-ok="onAddBtn" width="40"
            ...
            <Form :label-width="100">
              ...
              <Form-item class="form_item" label="课程简介:">
                <Input style="width: 200px" v-model="viewData.Add.courseDesc" type="textarea" placeholder="请输入"></Input>
              </Form-item>
              <Form-item class="form_item" label="课程分类:">
                <Select clearable placeholder="课程分类" @on-change="searchManage" v-model="viewData.Add.cateId"
                  class="search_item">
          ...
          <Modal v-model="viewData.modalEdit" title="编辑课程" :mask-closable="false" @on-ok="onEditBtn" width="40"
            ...
            <Form :label-width="100">
              ...
              <Form-item class="form_item" label="课程简介:">
                <Input style="width: 200px" v-model="viewData.Edit.courseDesc" type="textarea"
  ...
  data () {
    return {
      searchList: {
        ...
        //   key: 'isHot',
        //   render: (h, params) => {
        //     return h('span', params.row.isHot ? '热门' : '否')
        //   }
        // },
        // {
        //   title: '是否推荐',
        ...
        //   key: 'isRecommend',
        //   render: (h, params) => {
        //     return h('span', params.row.isRecommend ? '推荐' : '否')
        //   }
        // },
        {
          title: '是否上架',
